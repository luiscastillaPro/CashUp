...
const Registro = ({ onMostrarLogin }) => {
  ...
  const [mensajeExito, setMensajeExito] = useState(false); // Para la notificación de éxito
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMensajeExito(true); // Mostrar la notificación

      setTimeout(() => {
        setMensajeExito(false);
        onMostrarLogin(); // Cambia la vista al formulario de login
      }, 3000);
    } catch (error) {
  ...
  return (
    <div className="registro-wrapper-container">
      <div className="registro-container">
        {mensajeExito && (
          <div className="registro-notificacion">
            El registro se ha realizado con exito!!. Redirigiendo al login...
          </div>
        )}
